...
sed -i "s:$line_match:$line_match --enable-features=WebUIDarkMode --force-dark-mode:g" "$original_shortcut" # The //\//\\/ is used to escape forward slashes
...
echo "  $ sudo ./uninstall-chrome-dark-mode.sh"
echo
