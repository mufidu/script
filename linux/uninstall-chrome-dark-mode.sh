...
sed -i "s:$line_match --enable-features=WebUIDarkMode --force-dark-mode:$line_match:g" "$original_shortcut" # The //\//\\/ is used to escape forward slashes
